...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_generator', help='Path to existing generator weights file', default="MytrainingData/GanData/models/generat.h5")
    parser.add_argument('--load_discriminator', help='Path to existing discriminator weights file', default="MytrainingData/GanData/models/discrim.h5")
    parser.add_argument('--data', help='Path to directory of images of correct dimensions, using *.[filetype] (e.g. *.png) to reference images', default="MyTrainingData/train_png/C/*.png")
    ...
    parser.add_argument('--image_size', help='Size of images as tuple (height,width). Height and width must both be divisible by (2^5)', default="(224, 224)")
    parser.add_argument('--epochs', help='Number of epochs to train for', default=50000)
    parser.add_argument('--save_interval', help='How many epochs to go between saves/outputs', default=100)
    parser.add_argument('--output_directory', help="Directoy to save weights and images to.", default="MytrainingData/GanData/C")
